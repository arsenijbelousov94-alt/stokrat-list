// functions/api.js
// Cloudflare Pages Function — единый API: вход + CRUD списка + управление аккаунтами.
...
export async function onRequest(context) {
  ...
  if (!kv) {
    return json({ error: 'KV не подключён. Настройте привязку PEOPLE_KV в дашборде Cloudflare Pages.' }, 500);
  }
  ...
  // ---- Управление аккаунтами сотрудников (только суперадмин) ----
  ...
  // ---- Список людей (суперадмин или сотрудник) ----
